    ...
    <div className="p-5 container">
      ...
      <div className={`${openModal === true ? 'block' : 'hidden'} modal-terms`}>
        <div className="modal-terms-content">
          ...
          <div className="modal-gallery-wrapper fixed top-0 right-0 left-0 z-99 h-modal overflow-y-auto overflow-x-hidden md:inset-0 md:h-full items-center justify-center flex bg-gray-900 bg-opacity-50 dark:bg-opacity-80">
            <div className="relative h-full w-full p-4 md:h-auto max-w-2xl">
              ...
              setOpenModal(!openModal)
                ...
                <div className="p-2">
                  ...
                  <iframe id="6cdN7N8ntcY" className="playerLocation ytvideo" width="100%" height="360" src="https://www.youtube.com/embed/6cdN7N8ntcY?rel=0&amp;showinfo=0&amp;mute=1&amp;muted=1&amp;enablejsapi=1&amp;autoplay=1"></iframe>
