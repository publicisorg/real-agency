const Modals = () => {
    return <div className={`${openModal === true ? 'block' : 'hidden'} modal-terms`}>
        ...
        <div className="relative h-full w-full p-4 md:h-auto max-w-3xl">
          ...
          setOpenModal(!openModal)
            ...
            <div className="p-2">
              ...
              <iframe id="6cdN7N8ntcY" className="playerLocation ytvideo" width="100%" height="400" src="https://www.youtube.com/embed/6cdN7N8ntcY?rel=0&amp;showinfo=0&amp;mute=1&amp;muted=1&amp;enablejsapi=1&amp;autoplay=1"></iframe>
