  ...
  const manifesthtml = (
    ...
    <div className="py-16">
      <div className="text-center w-full relative">
        ...
        <div id="manifest-logo" className="absolute right-36 flex items-center aux-neg-bottom">
          <SpinningPublicis />
        </div>
      </div>
      <div className="flex justify-between items-center w-3/5 mx-auto my-12">
        <svg className="w-6" id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.15 23.15">
