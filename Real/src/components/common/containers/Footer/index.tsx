...
const Footers = () => {
  ...
  return (
    ...
    <footer className='container px-12 md:flex pb-12 md:pr-32'>
      <motion.div ref={ref} variants={boxVariant} animate={control} initial="hidden" className="w-1/2">
      ...
      <div className="w-1/2 pt-6 md:pt-0">
        <motion.p ref={ref} variants={boxVariant2} animate={control} initial="hidden">
      ...
      <motion.div ref={ref} variants={boxVariant3} animate={control} initial="hidden" className="w-1/2">
        <p>
